...
const (
	Post_GetPostById_FullMethodName = "/grpc.v1.Post/GetPostById"
)
...
//
// Post service provides RPC methods for post operations.
...
var Post_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "docs/proto/v1/post.proto",
}
